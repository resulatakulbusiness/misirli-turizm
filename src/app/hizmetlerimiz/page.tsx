...
const data: OverviewPageData = {
  ...
  items: {
    ...
    cards: [
      ...
      { label: "Sektörel planlama", title: "Sektörel Personel Servisi Çözümleri", text: <p>Lojistik, sağlık, ofis, plaza, AVM ve perakende işletmelerinin farklı çalışma ritimlerini özgün operasyon modelleriyle ele alır.</p>, href: "/sektorler" },
  ...
  focus: {
    ...
    points: ["B2B kurum ihtiyacına özel planlama", "Sektöre göre değişen vardiya ve erişim senaryoları", "Vardiya ve tesis yönü odaklı güzergâh kararı", "İç linklerle birbirini destekleyen hizmet sayfaları", "Doğrulanmış telefon, e-posta ve Pendik adresi", "Mobil uyumlu teklif ve iletişim akışı"],
  },
  faqs: [
    ...
    { question: "Sektörel personel servisi sayfaları hangi işletmeleri kapsıyor?", answer: "İlk içerik kümesi lojistik ve depo, sağlık ve hastane, ofis ve plaza ile AVM ve perakende işletmelerini kapsar. Her sektör vardiya, tesis erişimi, çalışan dağılımı ve satın alma kararları bakımından ayrı ele alınır." },
